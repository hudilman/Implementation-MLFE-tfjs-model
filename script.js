...
async function init(){
    ...
    model = await tf.loadLayersModel('http://127.0.0.1:8887/belajar web ML/tfjs_model/model.json');
    isModelLoaded = true;
 
    //Memanggil word_index
    // const word_indexjson = await fetch('http://127.0.0.1:5500/word_index.json'); // Untuk VS Code Live Server
    const word_indexjson = await fetch('http://127.0.0.1:8887/belajar web ML/word_index.json');
